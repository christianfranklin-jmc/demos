...
- [ ] T008 Merge DSA and PlatformAgent dependency lists in `/Users/mwebb/Projects/dsa-platform/frontend/package.json`: base = DSA's deps, add `aws-amplify@^6`, keep DSA's React 19, Vite 6, Tailwind 4. Run `npm install` from `frontend/`; commit the updated lockfile.
