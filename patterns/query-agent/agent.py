"""AgentCore Runtime entry point for the Query Agent (FAST pattern).
...
The Query Agent translates natural language to SQL, manages a semantic
query cache, validates and self-corrects SQL, classifies intent, and
generates dbt metric queries.
